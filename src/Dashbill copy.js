...
const Dashbill = () => {
    ...
    const DocumentSection = ({ title, items, searchTerm, setSearchTerm, navigate, onDelete, selectedClient }) => (
        <div className="clients-section">
            <div className="section-header">
                ...
                <div className="invoices-actions">
                    ...
                    >
                        ...
                        Créer un {title.toLowerCase().slice(0, -1)}
                    </button>
                </div>
            </div>
            ...
            {items.length === 0 ? (
                <div className="empty-state">
                    ...
                    <button onClick={() => navigate("/bill")} className="primary-btn">
                        <FaPlus /> Créer un {title.toLowerCase().slice(0, -1)}
                    </button>
                </div>
            ) : (
                                ...
                                <div className="client-actions">
                                    <button
                                        ...
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            navigate("/bill", {
                                                state: { facture: f, client: selectedClient }
                                            });
                                        }}
                                    >
                                        <FaEdit />
